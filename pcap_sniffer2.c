...
if(argc > 1 &&  (argv[1] != "eth0" || argv[1] != "eth1" || argv[1] != "eth2" || argv[1] != "eth3" ) ){
iface="eth0";
printf("eth 0 is considered as interface");
...
printf("Atleast one argument needed or use --options or -o to know more");
return 0 ;
}
